...
class AutoApp:
    ...
    def detection_funct(self, path):
        detections, found_dets, output_image = corner_dets_methods.find_contours(path, self.corner_num, self.quality, self.distance,
                                                                   self.detection_threshold)
        return detections, found_dets, output_image
    ...
    def select_pentagon(self):
        ...
        for file in file_list:
            if file.endswith('.png'):
                ...
                det, found_details, output_image = self.detection_funct(file)
                if found_details != []:
    ...
    def name_save_files(self, originalFileName):
        ...
        try:
            ...
            return ["Error_output.txt", "Error_Corner.csv", "Error_Line.csv", "Error_Gap", "Error_Figure"]
    ...
    def save_cmd(self, infile, output_image):
        try:
            ...
            save_file = r"SampleHistorcialPentCorners"
